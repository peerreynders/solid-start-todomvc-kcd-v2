...
import { loginHref, todosFilter, todosActiveHref, todosAllHref, todosCompleteHref, todosHref } from '~/route-path';
...
const filterAnchorCompleteModifier = (filtername: () => Filtername | undefined) =>
...
export default function TodosPage() {
  ...
  return (
    ...
    >
      <Show
        when={filtername()}
        fallback={<Navigate href={todosHref} />}
      >
        <Show
          when={user()}
              ...
              <footer class="c-todos__footer">
                ...
                <ul class="c-todos__filters">
                  <li class="c-todos__filter-item">
                    <A 
		      href={todosAllHref} 
		      class={'c-todos__filter-anchor ' + filterAnchorAllModifier(filtername)}
		    >
                      All
                    </A>
                  </li>{' '}
		      ...
		      class={'c-todos__filter-anchor ' + filterAnchorActiveModifier(filtername)}
		    >
                      Active
                    </A>
                  </li>{' '}
		      ...
		      class={'c-todos__filter-anchor ' + filterAnchorCompleteModifier(filtername)}
		    >
                      Completed
                    </A>
                  </li>{' '}
